...
def chatbot_response(query):
    ...
    return result if result else "Sorry, I couldn't find relevant information from the provided URL."

iface = gr.Interface(fn=chatbot_response, inputs="text", outputs="text", title="URL-Based AI Chatbot")
